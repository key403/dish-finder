...
const page = async ({searchParams}) => {
  const res = await fetch(`https://www.themealdb.com/api/json/v1/1/filter.php?c=${searchParams.c}`)
  const data = await res.json()
  const meals = data?.meals
  console.log(meals)

  return (
    <div className="container mt-2 mx-auto py-3 px-3 sm:px-5 lg:px-10 lg:pt-5 sm:pb-10">
